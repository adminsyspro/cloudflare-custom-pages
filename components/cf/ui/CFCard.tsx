...
export const CFCard = ({
  ...
  return (
    <Card
      ...
      className="w-full max-w-[820px] mx-auto overflow-hidden bg-white dark:bg-gray-900 shadow-xl ring-1 ring-gray-900/5 dark:ring-gray-800 m-2 sm:m-4 rounded-xl"
    >
      <CardHeader
